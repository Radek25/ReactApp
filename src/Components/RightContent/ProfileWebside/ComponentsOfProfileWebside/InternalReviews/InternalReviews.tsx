...
let TitleOfTable = [{Id: 1, Title: 'Name'}, {Id: 2, Title: 'Entity'}, {Id: 3, Title: 'Location'}, {Id: 4, Title: 'Expertise'}, {Id: 5, Title: 'Date'}]
...
export const InternalReviews: FC<ValueEdit> = (props) =>{
